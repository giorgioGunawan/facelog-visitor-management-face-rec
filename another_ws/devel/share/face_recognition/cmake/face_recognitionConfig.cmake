...
if("TRUE" STREQUAL "TRUE")
  set(face_recognition_SOURCE_PREFIX /home/giorgio/another_ws/src/procrob_functional)
  set(face_recognition_DEVEL_PREFIX /home/giorgio/another_ws/devel)
  ...
  set(face_recognition_INSTALL_PREFIX /home/giorgio/another_ws/install)
...
if(NOT "/home/giorgio/another_ws/devel/include " STREQUAL " ")
  set(face_recognition_INCLUDE_DIRS "")
  set(_include_dirs "/home/giorgio/another_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'face_recognition' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/giorgio/another_ws/src/procrob_functional/${idir}'.  Ask the maintainer 'Pouyan Ziafati (Author) <pouyan.ziafati@uni.lu>' to fix it.")
    endif()
